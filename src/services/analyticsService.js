  ...
  async getData(period = "all", branchName = null) {
    ...
    return {
      ...
      financeAnalytics: {
        ...
        revenueByCurrency: finance.revenueByCurrency || reportData.revenueByCurrency || {},
        expensesByCurrency: finance.expensesByCurrency || reportData.expensesByCurrency || {},
        inkassaByCurrency: finance.inkassaByCurrency || reportData.inkassaByCurrency || {},
        debtByCurrency: finance.debtByCurrency || reportData.debtByCurrency || {},
        netProfitByCurrency: finance.netProfitByCurrency || reportData.netProfitByCurrency || {},
        cashOnHandByCurrency: finance.cashOnHandByCurrency || reportData.cashOnHandByCurrency || {},
      },
      currencyAnalytics: objectToChart(reportData.revenueByCurrency, "currency", "amount"),
      currencyFinanceAnalytics: Object.keys(reportData.revenueByCurrency || {}).map((currency) => ({
        currency,
        revenue: toNumber(reportData.revenueByCurrency?.[currency]),
        expenses: toNumber(reportData.expensesByCurrency?.[currency]),
        inkassa: toNumber(reportData.inkassaByCurrency?.[currency]),
        debt: toNumber(reportData.debtByCurrency?.[currency]),
        netProfit: toNumber(reportData.netProfitByCurrency?.[currency]),
        cashOnHand: toNumber(reportData.cashOnHandByCurrency?.[currency]),
      })),
